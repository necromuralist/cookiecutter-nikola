...
BLOG_AUTHOR = "{{cookiecutter.author}}"  # (translatable)
BLOG_TITLE = "{{cookiecutter.title}}"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://necromuralist.github.io/{{cookiecutter.project_name}}/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://necromuralist.github.io/"
BLOG_EMAIL = "{{cookiecutter.email}}"
BLOG_DESCRIPTION = "{{cookiecutter.description}}."  # (translatable)
...
<input type="submit" value="DuckDuckGo Search" style="visibility: hidden;display:none">
</form>
